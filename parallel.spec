...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20241222.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20241222.tar.bz2.sig
...
%setup -q -n parallel-20241222
cd %{_builddir}/parallel-20241222
pushd ..
cp -a parallel-20241222 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735072268
