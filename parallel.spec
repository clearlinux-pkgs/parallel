...
Version  : 20240122
Release  : 97
URL      : https://mirrors.kernel.org/gnu/parallel/parallel-20240122.tar.bz2
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20240122.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20240122.tar.bz2.sig
...
%prep
%setup -q -n parallel-20240122
cd %{_builddir}/parallel-20240122
pushd ..
cp -a parallel-20240122 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706110318
