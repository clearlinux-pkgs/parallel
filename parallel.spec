...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20240822.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20240822.tar.bz2.sig
...
%setup -q -n parallel-20240822
cd %{_builddir}/parallel-20240822
pushd ..
cp -a parallel-20240822 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724281898
