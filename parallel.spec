...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20240722.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20240722.tar.bz2.sig
...
%setup -q -n parallel-20240722
cd %{_builddir}/parallel-20240722
pushd ..
cp -a parallel-20240722 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721660346
