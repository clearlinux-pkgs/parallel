...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20200522.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20200522.tar.bz2.sig
...
%prep
%setup -q -n parallel-20200522
cd %{_builddir}/parallel-20200522
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590372589
...
cp %{_builddir}/parallel-20200522/COPYING %{buildroot}/usr/share/package-licenses/parallel/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
