...
Version  : 20240322
Release  : 99
URL      : https://mirrors.kernel.org/gnu/parallel/parallel-20240322.tar.bz2
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20240322.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20240322.tar.bz2.sig
...
%prep
%setup -q -n parallel-20240322
cd %{_builddir}/parallel-20240322
pushd ..
cp -a parallel-20240322 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711998654
