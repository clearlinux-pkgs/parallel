...
Version  : 20231022
Release  : 93
URL      : https://mirrors.kernel.org/gnu/parallel/parallel-20231022.tar.bz2
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20231022.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20231022.tar.bz2.sig
...
%prep
%setup -q -n parallel-20231022
cd %{_builddir}/parallel-20231022
pushd ..
cp -a parallel-20231022 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698158247
