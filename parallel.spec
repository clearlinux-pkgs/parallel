...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20240622.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20240622.tar.bz2.sig
...
%setup -q -n parallel-20240622
cd %{_builddir}/parallel-20240622
pushd ..
cp -a parallel-20240622 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719273320
...
cp %{_builddir}/parallel-%{version}/COPYING %{buildroot}/usr/share/package-licenses/parallel/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
