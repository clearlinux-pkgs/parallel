...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20230222.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20230222.tar.bz2.sig
...
%prep
%setup -q -n parallel-20230222
cd %{_builddir}/parallel-20230222
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677182149
