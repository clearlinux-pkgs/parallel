...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20240222.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20240222.tar.bz2.sig
...
%prep
%setup -q -n parallel-20240222
cd %{_builddir}/parallel-20240222
pushd ..
cp -a parallel-20240222 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709134830
