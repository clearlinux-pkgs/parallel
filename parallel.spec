...
Version  : 20211122
Release  : 71
URL      : https://mirrors.kernel.org/gnu/parallel/parallel-20211122.tar.bz2
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20211122.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20211122.tar.bz2.sig
...
%prep
%setup -q -n parallel-20211122
cd %{_builddir}/parallel-20211122
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637682533
...
cp %{_builddir}/parallel-20211122/LICENSES/CC-BY-SA-4.0.txt %{buildroot}/usr/share/package-licenses/parallel/f26cccd93362d640ef2c05d1c52b5efe1620a9b2
cp %{_builddir}/parallel-20211122/LICENSES/GFDL-1.3-or-later.txt %{buildroot}/usr/share/package-licenses/parallel/9f4b4e87b606c795e2ff126522fec25546fb335f
cp %{_builddir}/parallel-20211122/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/parallel/e3bdbf20d43fc066a1b40a64d57d4ae5a31f177f
%make_install
