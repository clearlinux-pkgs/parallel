...
Source0  : https://mirrors.kernel.org/gnu/parallel/parallel-20230822.tar.bz2
Source1  : https://mirrors.kernel.org/gnu/parallel/parallel-20230822.tar.bz2.sig
...
%prep
%setup -q -n parallel-20230822
cd %{_builddir}/parallel-20230822
pushd ..
cp -a parallel-20230822 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692892007
